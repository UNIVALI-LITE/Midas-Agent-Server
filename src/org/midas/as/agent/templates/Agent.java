...
/**
 * The Agent template is one of the main classes of the MIDAS structure. It큦
 ...
 * the methods that are invoked by the architecture to require the agent큦 services,
...
public abstract class Agent implements Provider,Callable<Object>
{
	...
	/**
	 * Abstract method that acts as the providing interface for the agent큦 services, 
	...
	/**
	 * Implemented method from the Callable interface, it큦 invoked in a separate thread
	 * from an execution pool, to fire the agent큦 life cycle. Must not be invoked directly. 
	 * 
