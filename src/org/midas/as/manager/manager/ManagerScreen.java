...
public class ManagerScreen
{
	...
	public static void show() throws ManagerException
	{
		...
		{			
			...
			if (manager.isInitialized())
			{
				...
				{
					organizationIcon = tk.getImage(path+"/images/organizationIcon.gif");
					componentIcon = tk.getImage(path+"/images/componentIcon.gif");
					agentIcon = tk.getImage(path+"/images/agentIcon.gif");
					serviceIcon = tk.getImage(path+"/images/serviceIcon.gif");
					folderIcon = tk.getImage(path+"/images/folderIcon.gif");					
				}
	...
	private static void refreshServices()
	{
		...
		{			
			...
			// Preenchendo Árvore de Construção
			organizations = Catalog.getContainerInfo().getOrganizations();
