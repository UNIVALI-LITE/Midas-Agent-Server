...
public class TomcatStartup 
{
     ...
     */
    public void startTomcat(int port) throws Exception 
    {    	
        Engine engine = null;
        ...
        Context appCtx = this.embedded.createContext("/agentserver", getPath() + "/webapps/agentserver");
	    ...
	    // create another application Context
        appCtx = this.embedded.createContext("/application", new File("").getAbsolutePath() + "/web" );
        appCtx.setPrivileged(true);
        this.host.addChild(appCtx); // add context to host
